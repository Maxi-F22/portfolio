      ...
      <Header
        ...
        text={
          <>
            ...
            If you are specifically interested in one of the fields, search for it using CTR+F.<br /><br />
            To load the embedded GitHub pages projects, click the button in the middle of the window. 
          </>
        }
      />
              ...
              {typedProjects.map((project) => (
                ...
                >
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="ml-3 mt-3 inline-flex rounded-xl border border-[#2a355c] px-3 py-2 text-sm transition hover:-translate-y-0.5 hover:border-[#56c7ff]"
                  >
                    Open Repository
                  </a>
                </article>
